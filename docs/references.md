...
| **B13** | Cost centers support an AI credit pool cap (single `ai_credit_pool_enabled` boolean, auto-sized to 3,000/7,000 AIC per license; behavior at the cap = the enterprise overages policy, **not** a per-CC block/overage field; API-only, UI early July) | https://github.blog/changelog/2026-07-02-cost-centers-now-support-included-usage-caps/ |
