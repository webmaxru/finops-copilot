...
| Enterprise limit ($0–$12,000) | **Enterprise metered budget** — caps overage **on top of** license fees (`max bill = licenses + budget`) |
...
**Enterprise (global):** total licenses (1–1000), Business/Enterprise ratio, % of seats that actually use Copilot, **average developer monthly usage** (credits, with $ caption), power-user ratio, power-user multiplier (2×–5×), **usage variation**, individual limit ($), enterprise limit ($0–$12k, absolute USD metered budget), promo-allowances toggle, stop-usage toggle.
